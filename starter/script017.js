...
const num =23;
if (num == "23"){                 //l'opérateur == compare uniquement les valeurs
...
if (num ==="23"){                 // l'opérateur strict === compare la valeur et le type, donc false car l'un string et l'autre number
    console.log("J'ai testé si 23 était égal à '23' sans vérifier le type.");
}else {
    console.log('l\'égalité stricte ne fonctionne pas')
}